...
// GET /users/:id
usersRouter.get('/:id', validate(userIdParam), async (req, res) => {
...
// POST /users
usersRouter.post('/', validate(createUserDto), async (req, res) => {
...
// PUT /users/:id
usersRouter.put('/:id', validate(userIdParam), validate(updateUserDto), async (req, res) => {
...
// DELETE /users/:id
usersRouter.delete('/:id', validate(userIdParam), async (req, res) => {
